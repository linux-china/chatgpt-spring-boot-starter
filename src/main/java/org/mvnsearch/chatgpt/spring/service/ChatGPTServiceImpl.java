...
public class ChatGPTServiceImpl implements ChatGPTService {
    ...
    private final Map<String, JsonSchemaFunction> allJsonSchemaFunctions = new HashMap<>();
        ...
        for (GPTFunctionsStub functionStub : stubs) {
            ...
            if (!functions.isEmpty()) {
                for (Map.Entry<String, JsonSchemaFunction> entry : functions.entrySet()) {
                    final JsonSchemaFunction jsonSchemaFunction = entry.getValue();
    ...
    private void injectFunctionCallLambda(ChatMessage chatMessage) {
        ...
        if (functionCall != null) {
            ...
            JsonSchemaFunction jsonSchemaFunction = allJsonSchemaFunctions.get(functionName);
